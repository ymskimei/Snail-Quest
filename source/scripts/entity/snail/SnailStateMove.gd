...
func enter() -> void:
	...
	entity.animator.play("SnailMove")

func input(_event: InputEvent) -> int:
	if entity.can_move:
		if entity.controllable and !entity.can_interact and Input.is_action_just_pressed("action_main") and is_on_floor:
			return State.JUMP
		if entity.controllable and Input.is_action_just_pressed("action_defense"):
