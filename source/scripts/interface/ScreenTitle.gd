...
onready var cam: SpringArm = $World/SpringArm

onready var anim_fade: AnimationPlayer = $GuiTransition/AnimationPlayer
...
var splashes: Array = [
	"TITLE_SPLASH_0", "TITLE_SPLASH_1", "TITLE_SPLASH_2",
	"TITLE_SPLASH_3", "TITLE_SPLASH_4", "TITLE_SPLASH_5",
	"TITLE_SPLASH_6", "TITLE_SPLASH_7", "TITLE_SPLASH_8",
	"TITLE_SPLASH_9"
]
...
func _on_StartButton_pressed() -> void:
	...
	anim_fade.play("GuiTransitionFade")
