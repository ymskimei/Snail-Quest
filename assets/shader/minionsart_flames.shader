// This shader is from GDQuest's Godot Shaders, who adapted it from Minionsart's stylized fire 
// for unity from (https://twitter.com/minionsart/status/1132593681452683264?s=20)
//
