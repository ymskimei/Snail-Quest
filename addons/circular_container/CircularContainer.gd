...
## Properties ##
var _force_squares = false: get = _private_get, set = _private_set
var _force_expand = false: get = _private_get, set = _private_set
var _start_angle = 0: get = _private_get, set = _private_set
var _percent_visible = 1: get = _private_get, set = _private_set
var _appear_at_once = false: get = _private_get, set = _private_set
var _allow_node2d = false: get = _private_get, set = _private_set
var _start_empty = false: get = _private_get, set = _private_set
var _custom_animator()_func = null: get = _private_get, set = _private_set

## Cached variables ##
var _cached_min_size_key = "": get = _private_get, set = _private_set
var _cached_min_size = null: get = _private_get, set = _private_set
var _cached_min_size_dirty = false: get = _private_get, set = _private_set
