...
const i_stick_main_left: String = "joy_left"
const i_stick_main_right: String = "joy_right"
const i_stick_main_up: String = "joy_up"
const i_stick_main_down: String = "joy_down"
const i_action_main: String = "action_main"
const i_action_alt: String = "action_alt"
const i_action_sub_0: String = "action_sub_0"
const i_action_sub_1: String = "action_sub_1"
const i_pad_left: String = "pad_left"
const i_pad_right: String = "pad_right"
const i_pad_up: String = "pad_up"
const i_pad_down: String = "pad_down"
const i_stick_alt_left: String = "cam_left"
const i_stick_alt_right: String = "cam_right"
const i_stick_alt_up: String = "cam_up"
const i_stick_alt_down: String = "cam_down"
const i_trigger_right: String = "action_defense"
const i_trigger_left: String = "cam_lock"
const i_button_right: String = "cam_zoom"
const i_button_left: String = ""
const i_stick_main: String = ""
const i_stick_alt: String = ""
const i_main_0: String = "gui_pause"
const i_main_1: String = "gui_items"
const i_screenshot: String = "screenshot"
const i_debug_menu: String = "debug_menu"
const i_debug_menu_nav_up: String = "debug_menu_nav_up"
const i_debug_menu_nav_down: String = "debug_menu_nav_down"
const i_debug_menu_clear: String = "debug_menu_clear"
const i_debug_save: String = "debug_save"
const i_debug_load: String = "debug_load"
const i_debug_cam_higher: String = "debug_cam_higher"
const i_debug_cam_lower: String = "debug_cam_lower"
const i_debug_speed_up: String = "debug_cam_speed_up"
const i_debug_speed_down: String = "debug_cam_speed_down"
const i_debug_fov_increase: String = "debug_fov_increase"
const i_debug_fov_decrease: String = "debug_fov_decrease"
...
func _input(event: InputEvent) -> void:
	...
	var not_changed_just_then = Engine.get_process_frames() - device_last_changed_at > Engine.get_frames_per_second()
	if next_device != device or (next_device_index != device_index and not_changed_just_then):
		device_last_changed_at = Engine.get_process_frames()
		device = next_device
...
func get_action_key(action: String) -> String:
	for event in InputMap.action_get_events(action):
		if event is InputEventKey:
			var keycode = OS.keyboard_get_scancode_from_physical(event.physical_keycode) if event.physical_keycode != 0 else event.keycode
