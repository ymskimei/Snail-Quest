...
# 最大発音数
@export var max_polyphony:int = 96: set = set_max_polyphony
# ファイル
@export var file:String = "": set = set_file
# 再生中か？
@export var playing: bool = false
# 再生速度
@export var play_speed:float = 1.0 # (float, 0.0, 100.0)
# 音量
...
# サウンドフォント
@export var soundfont:String = "": set = set_soundfont
...
# 1秒間処理する回数
@export var sequence_per_seconds:int = 120 # (int, 10, 480)
